...
2. A TaskResult can only get a result once; attempting to do so again will result in an error. Can you translate this readme into English for me so that I can copy and paste it directly?
